                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a onclick="confirm_modal('{{route('pages.testimonialedit', $flash_deal->id)}}');">{{__('Delete')}}</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
...
@section('script')
    <script type="text/javascript">
        ...
        function update_testimonial_status(el){
            ...
            // $.post('{{ route('pages.testimonialupdate_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
            //     if(data == 1){
            //         location.reload();
            //     }
            //     else{
