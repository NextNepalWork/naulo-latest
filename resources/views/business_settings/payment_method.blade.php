   ...
   <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('Esewa')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="ESEWA_KEY">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('ESEWA_ Key')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="ESEWA_KEY" value="{{  env('ESEWA_KEY') }}" placeholder="ESEWA_KEY" required>
                        </div>
                    </div>
