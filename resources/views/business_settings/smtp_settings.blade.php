                ...
                <form class="form-horizontal" action="{{ route('env_key_update.update') }}" method="POST">
                    ...
                    <div id="smtp">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MAIL_HOST" value="{{ Config::get('mail.host') }}" placeholder="MAIL HOST">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MAIL_PORT" value="{{ Config::get('mail.port') }}" placeholder="MAIL PORT">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MAIL_USERNAME" value="{{ Config::get('mail.username') }}" placeholder="MAIL USERNAME">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MAIL_PASSWORD" value="{{ Config::get('mail.password') }}" placeholder="MAIL PASSWORD">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MAIL_ENCRYPTION" value="{{ Config::get('mail.encryption') }}" placeholder="MAIL ENCRYPTION">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MAIL_FROM_ADDRESS" value="{{ Config::get('mail.from.address') }}" placeholder="MAIL FROM ADDRESS">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MAIL_FROM_NAME" value="{{ Config::get('mail.from.name') }}" placeholder="MAIL FROM NAME">
                            </div>
                        </div>
                    </div>
                    <div id="mailgun">
