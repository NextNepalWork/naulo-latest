                        ...
                        <form class="" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Name')}} <span class="required-star" style="color:red;">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Category')}} <span class="required-star" style="color:red;">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Brand')}} <span class="required-star" style="color:red;">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Unit')}} <span class="required-star" style="color:red;">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Tag')}} <span class="required-star" style="color:red;">*</span></label>
                                        </div>
                                        <div class="col-md-10">
