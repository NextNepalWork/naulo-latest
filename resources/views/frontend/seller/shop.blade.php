                        ...
                        <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            @if ($shop->logo)
                                                @if (file_exists($shop->logo))
                                                    <img style="max-width:50%" src="{{asset($shop->logo)}}" alt="{{$shop->name}}">  
                                                @endif                                                  
                                            @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" placeholder="{{__('Phone')}}" name="phone" value="{{ Auth::user()->phone }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Pan Number')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" placeholder="{{__('Pan Number')}}" name="pan_no" value="{{ $seller->pan_no }}" required>
                                        </div>
                                    </div>
