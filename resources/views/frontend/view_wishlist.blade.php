                        ...
                        <div class="product_tbl">
                            ...
                            <table class="table">
                                ...
                                <tbody class="wishlist__tbody">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="wishlist__trash" id="wishlist_{{ $wishlist->id }}"><a  onclick="removeFromWishlist({{$wishlist->id}})"><i class="icon-trash2"></i></a></div>
                                        </td>
                                        <td>
                                      ...
                                      <td><span class="ps-product__instock">In Stock</span></td>
                                      @else
                                      <td><span class="ps-product__ofstock">Out of stock</span></td>
                                      @endif
                                        </td>
                                        <td>
