                        ...
                        <form action="{{ route('payment.checkout') }}" class="form-default" data-toggle="validator" role="form" method="POST" id="checkout-form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label class="payment_option mb-4" data-toggle="tooltip" data-title="Esewa">
                                                        <input type="radio" id="" name="payment_option" value="esewa" checked>
                                                        <span>
                                                            <img loading="lazy"  src="{{ asset('frontend/images/icons/cards/esewa_logo.png')}}" class="img-fluid">
                                                        </span>
                                                    </label>
                                                </div>
                                            @endif
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-6 text-right">
                                    <button type="button" onclick="submitOrder(this)" class="btn btn-styled btn-base-1" style='color:#26901b'>{{__('Complete Order')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
