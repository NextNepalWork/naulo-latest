                    ...
                    <div class="form-default bg-white p-4">
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-md-6 text-right">
                                @if(Auth::check())
                                    <a href="{{ route('checkout.shipping_info') }}" class="btn-con" style='color:#26901b'>{{__('Continue to Shipping')}}</a>
                                @else
                                    <button class="btn btn-styled btn-base-1" onclick="showCheckoutModal()" style='color:#26901b'>{{__('Continue to Shipping')}}</button>
                                @endif
                            </div>
                        </div>
                    </div>
