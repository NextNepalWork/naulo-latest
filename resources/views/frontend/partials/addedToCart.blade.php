<div id="popupAddToCart" class="modal-body p-4 added-to-cart">
    ...
    <div class="text-center">
        <button class="btn btn-warning btn-lg ml-5" data-dismiss="modal">{{__('Back to shopping')}}</button>
        <a href="{{ route('cart') }}" class="btn btn-success btn-lg ml-5">{{__('Proceed to Checkout')}}</a>
    </div>
</div>
