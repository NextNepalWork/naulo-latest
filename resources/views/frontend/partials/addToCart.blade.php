...
<div class="modal-body p-4">
    <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
            ...
            <div class="product-gal sticky-top d-flex flex-row-reverse">
                ...
                @if(is_array(json_decode($product->photos)) && count(json_decode($product->photos)) > 0)
                    <div class="product-gal-img">
                        <img src="{{ asset(json_decode($product->photos)[0]) }}" class="xzoom img-fluid lazyload"
        ...
        <div class="col-lg-6">
            <!-- Product description -->
            <div class="product-description-wrapper ml-5">
                <!-- Product title -->
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    ...
                                    <div class="avialable-amount">
                                      ...
                                      (<span id="available-quantity">{{ $product->current_stock }}</span> {{__('available')}})
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-table width-100 mt-3">
                    <div class="d-table-cell">
                        ...
                        @if ($product->digital == 1)
                            <button type="button"
                                    class="btn btn-warning  btn-lg add-to-cart ml-5 add-to-cart"
                                    onclick="addToCart()">
