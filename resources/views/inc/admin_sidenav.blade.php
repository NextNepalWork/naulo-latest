                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                               ...
                               <li class="{{ areActiveRoutes(['earning.report'])}}">
                                    <a class="nav-link" href="{{ route('earning.report') }}">{{__('Seller Earning Report')}}</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['generalsettings.color'])}}">
                                 ...
                                 <li class="{{ areActiveRoutes(['generalsettings.color'])}}">
                                    <a class="nav-link" href="{{url('admin/become/vendor')}}">{{__('Become A vendor')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['generalsettings.color'])}}">
