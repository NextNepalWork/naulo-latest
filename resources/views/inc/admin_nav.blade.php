        ...
        <div class="navbar-header">
            <a href="{{route('admin.dashboard')}}" class="navbar-brand">
                ...
                <div class="brand-title">
                    <span class="brand-text">Naulo Bazar</span>
                </div>
            </a>
        </div>
                ...
                <li class="dropdown">
                    ...
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true">
                        ...
                        @if($orders > 0 || $sellers > 0)
                            <span class="badge badge-header badge-danger">{{ $orders }}</span>
                        @endif
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="opacity: 1;">
                        <div class="nano scrollable has-scrollbar" style="height: 265px;">
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                ...
                                <ul class="head-list">
                                @php
                      		 	 $order = \App\Order::latest()->get()->take(10);
                                 ...
                                 <a class="media" href="{{ route('orders.index.admin') }}" style="position:relative">
                                                ...
                                                <div class="media-body">
                                                  ...
                                                  <p class="mar-no text-nowrap text-main text-semibold">Order ID : {{$order->id}}</p>
                                                   <p class="mar-no text-nowrap text-main text-semibold"> Order Code:{{$order->code}}</p>
                                                	 <p class="mar-no text-nowrap text-main text-semibold">Date:{{\Carbon\Carbon::parse($order->date)->isoFormat('MMM Do YYYY') }}</p>
                                                </div>
                                            </a>
                                  </li>
                                 @endforeach
            			...
            			<a href="{{ route('orders.index.admin') }}">See All </a>
           					 </div>
                            </div>
