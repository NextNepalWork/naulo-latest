...
Route::get('page/esewa_payment_success','EsewaPaymentController@success');
Route::get('page/esewa_payment_failed','EsewaPaymentController@fail');
...
Route::get('/account', 'HomeController@account')->name('mobile.account');
//Home Page
...
Route::get('/naulobazar','HomeController@nauloBazar')->name('naulobazar');
...
Route::get('/sellers','HomeController@sellersList')->name('seller');
...
Route::get('/flasale/visit', 'HomeController@flashale')->name('flashsale.visit');
...
Route::post('/subscriber/store', 'HomeController@suscribestore')->name('homesubscribers.store');
...
Route::get('/top-selling','HomeCategoryController@topSell')->name('topsell');
...
Route::group(['middleware' => ['user', 'verified']], function(){
	...
	Route::get('/order','HomeController@showOrder')->name('customer.order');
  	Route::get('/return','HomeController@showReturn')->name('customer.return');
  	Route::get('seller/orders','HomeController@showOrders')->name('seller.orders');
  	Route::get('/cancel','HomeController@showCancel')->name('customer.cancel');
...
Route::group(['prefix' =>'seller', 'middleware' => ['seller', 'verified']], function(){
  ...
  Route::get('/flashprodct', 'HomeController@vendorFlashDeal')->name('seller.FlashDealproduct');
  Route::get('/flashprodct/create', 'HomeController@vendorFlashDealcreate')->name('seller.FlashDealproductcreate');
	...
	//flashdealseller
	//flashdealseller
	Route::get('/flashprodct/vendor', 'HomeController@vendorFlashDeal')->name('seller.FlashDealproduct');
    Route::post('/flash_deals/vendor/store', 'HomeController@storeflash')->name('seller.flash_deals.store');
    Route::get('/flash_deals/vendor/destroy/{id}', 'HomeController@destroyflash')->name('seller.flash_deals.destroy');
	Route::post('/flash_deals/vendor/product_discount', 'HomeController@product_discount')->name('seller.flash_deals.product_discount');
	Route::post('/flash_deals/vendor/product_discount_edit', 'HomeController@product_discount_edit')->name('seller.flash_deals.product_discount_edit');
    Route::get('/flashprodct/vendor/create', 'HomeController@vendorFlashDealcreate')->name('seller.FlashDealproductcreate');
    Route::get('/flashprodct/vendor/edit/{id}', 'HomeController@vendorFlashDealedit')->name('seller.FlashDealproductedit');
    Route::post('/flashprodct/vendor/update/{id}', 'HomeController@vendorFlashDealupdate')->name('seller.FlashDealproductupdate');
