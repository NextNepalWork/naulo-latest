...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::group(['prefix' => 'frontend_settings'], function(){
		...
		Route::get('/home_banners/create/{position}', 'BannerController@create')->name('home_banners.create');
      	Route::get('/home_banners/login_content/create/{position}', 'LoginContentController@create')->name('login_content.create');
      	Route::get('/home_banners/login_content/edit/{id}','LoginContentController@edit')->name('login_content.edit');
      	Route::post('/home_banners/login_content/store','LoginContentController@store')->name('login_content.store');
      	Route::post('home_banners/login_content/update/{id}','LoginContentController@update')->name('login_content.update');
      	Route::post('/home_banners/login_content/update_status', 'LoginContentController@update_status')->name('login_content.update_status');
      	Route::get('home_banners/login_content/destroy/{id}','LoginContentController@destroy')->name('login_content.destroy');
	...
	Route::get('/flash_deal/seller', 'FlashDealController@sellerFlashDeal')->name('flash_deals.seller');
    Route::get('/flash_deals/destroy/{id}', 'FlashDealController@destroy')->name('flash_deals.destroy');
	Route::post('/flash_deals/update_statu', 'FlashDealController@update_status')->name('flash_deal.update_status');
	...
	Route::get('/wish_report', 'ReportController@wish_report')->name('wish_report.index');
  	Route::get('/seller-earning','ReportController@sellerEarningReport')->name('earning.report');
    ...
    Route::get('/become/vendor', function (){
		return view ('becomeavencorcreate');

		});
  Route::post('/becomeavendor/store', 'PageController@becomeavendor')->name('pages.become');
    ...
    Route::post('/flash_deals/update_status', 'PageController@testimonialupdate_status')->name('pages.testimonialupdate_status');
});
